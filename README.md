# Truss [![Build Status](https://travis-ci.org/gitwak/truss.svg?branch=master)](https://travis-ci.org/gitwak/truss)
...
1. Install Truss with
	...
	```
	go get -u -d github.com/gitwak/truss
	cd $GOPATH/src/github.com/gitwak/truss
	make dependencies
	make
	```
