...
import (
	...
	"github.com/gitwak/truss/cmd/_integration-tests/transport/transportpermutations-service/handlers"
	"github.com/gitwak/truss/cmd/_integration-tests/transport/transportpermutations-service/svc"
