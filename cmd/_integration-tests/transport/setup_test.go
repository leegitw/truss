...
import (
	...
	handler "github.com/gitwak/truss/cmd/_integration-tests/transport/transportpermutations-service/handlers"
	svc "github.com/gitwak/truss/cmd/_integration-tests/transport/transportpermutations-service/svc"
)
