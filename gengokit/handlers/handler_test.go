...
import (
	...
	helper "github.com/gitwak/truss/gengokit/gentesthelper"
...
func TestApplyServerTempl(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/gitwak/truss/gengokit/general-service",
	...
	expected := `
		...
		import (
			...
			pb "github.com/gitwak/truss/gengokit/general-service"
		)
