...
import (
	...
	"github.com/gitwak/truss/gengokit"
	templateFileAssets "github.com/gitwak/truss/gengokit/template"
	"github.com/gitwak/truss/svcdef"

	"github.com/gitwak/truss/gengokit/gentesthelper"
)
...
func TestApplyTemplateFromPath(t *testing.T) {
	const def = `
		...
		import "github.com/gitwak/truss/deftree/googlethirdparty/annotations.proto";
	...
	conf := gengokit.Config{
		GoPackage: "github.com/gitwak/truss",
		PBPackage: "github.com/gitwak/truss/gengokit/general-service",
	}
...
func TestAllTemplates(t *testing.T) {
	const goPackage = "github.com/gitwak/truss/gengokit"
	const goPBPackage = "github.com/gitwak/truss/gengokit/general-service"
	...
	conf := gengokit.Config{
		GoPackage: "github.com/gitwak/truss/gengokit",
		PBPackage: "github.com/gitwak/truss/gengokit/general-service",
	}
